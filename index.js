...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector("#search-icon").addEventListener("click", () => {
    ...
    searchInput.style.display = searchInput.classList.contains("research") ? "flex" : "none";
    searchInput.style.display = searchInput.classList.contains("research") ? "flex" : "none";
    searchSign.style.display = searchInput.classList.contains("research") ? "flex" : "none";
    obj.style.display = searchInput.classList.contains("research") ? "flex" : "none";
    obj.style.height = searchInput.classList.contains("research") ? "170px" : "0px";
    obj.style.flexDirection = searchInput.classList.contains("research") ? "column" : "";
  });
...
document.addEventListener("click", (e) => {
  ...
  if (targetClasses.some(cls => e.target.classList.contains(cls))) {
    const target = e.target.classList.contains("content") ? e.target : e.target.parentNode;
